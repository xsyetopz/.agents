---
name: bun-migration
description: Use this skill when migrating a JavaScript or TypeScript repository from Bun 1.3.14 to Bun 1.4+ or initializing Biome 2.5.10 in a new Bun project; use ordinary dependency maintenance when no Bun migration is intended.
---
