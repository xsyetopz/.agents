---
name: bun14-migration
description: Use this skill when migrating a JavaScript or TypeScript repository to Bun 1.4+ or initializing Biome 2.5.10 in a new Bun project; use ordinary dependency maintenance when no Bun migration is intended.
---
...
5. Apply the Biome 2.5.10 baseline only for a new project without configuration; for an existing configuration, preserve content and update only the package version and existing schema URL.
