...
- A tracked client hook is bypassable and does not enforce hosted merges or other clones.
...
- Use established Git mechanisms and repository-owned formats rather than custom schemas or generated evidence files.
