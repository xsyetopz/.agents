...
Load this reference when changelog audit is part of the repository documentation task. Verify every command, link, version, and product claim against current repository source truth.
