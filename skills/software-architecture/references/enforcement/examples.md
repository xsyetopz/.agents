...
obsolete paths and empty directories. A public-path constraint must be recorded in an existing repository-owned decision or policy format. Do not create a custom provenance schema, waive the finding, or add an undocumented alias.
