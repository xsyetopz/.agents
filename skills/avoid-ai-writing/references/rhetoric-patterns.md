...
Tell-don't-show for emotions. When an emotion is claimed, the writing around it
...
rhetorical questions to stall. When the answer is established, state it directly.
...
The..." AI restates the prompt before answering. Answer directly.
