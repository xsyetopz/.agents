...
- "I recently had the pleasure of [verb]-ing" → state what happened
...
- "Here's what's interesting" / "Here's what caught my eye" → let the content
  signal its own importance. When a lead-in is needed, make it specific
- "In conclusion" / "In summary" / "To summarize" → state the conclusion directly
