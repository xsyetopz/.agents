...
*Image description: The HomeKit icon.*
...
*Image description: The Apple Home app icon, which includes a stylized house with a chimney on the right side of its roof, depicted in graduated shades of orange.*
...
*Image description: An illustration of an incorrectly used HomeKit icon in a circular button styled with a chrome appearance.*

*Image description: An X in a circle to indicate incorrect usage.*

*Image description: An illustration of a button incorrectly titled 'HomeKit' with a custom gradient background.*
...
*Image description: The first in a series of images showing examples of the HomeKit icon when used in text. In this example, the icon correctly appears first in the line, and then the text 'Lights set with HomeKit.'*

*Image description: A checkmark in a circle to indicate correct usage.*

*Image description: The second in a series of images showing examples of the HomeKit icon when used in text. This example depicts the icon incorrectly positioned after the word 'with' in the text 'Lights set with HomeKit.'*

*Image description: An X in a circle to indicate incorrect usage.*

*Image description: The third in a series of images showing examples of the HomeKit icon when used in text. This example depicts the icon incorrectly positioned at the end of the line of text that reads 'Lights set with'.*
...
| *Image description: A checkmark in a circle to indicate correct usage.* | You can use HomeKit with [App Name]. |
| *Image description: An X in a circle to indicate incorrect usage.* | HomeKit lightbulbs. |
...
| *Image description: An X in a circle to indicate incorrect usage.* | Open Home. |
...
- [performAccessorySetup(using:completionHandler:)](https://developer.apple.com/documentation/HomeKit/HMAccessorySetupManager/performAccessorySetup(using:completionHandler:))
