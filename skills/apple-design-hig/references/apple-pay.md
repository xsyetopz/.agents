...
*Image description: A screenshot of an Apple Pay payment sheet that displays details about a food truck purchase, including a payment method and the total amount.*
...
*Image description: Correct usage*

*Image description: An illustration that shows the incorrect arrangement of the Apple Pay logo above a custom button titled 'Apple Pay'.*

*Image description: Incorrect usage*
...
*Image description: An illustration of an Apple Pay order confirmation screen on iPhone. The screen contains a button for creating an account, a button for signing up with Apple, and existing account login fields.*
...
*Image description: A screenshot of an in-app payment sheet that includes an additional charge for gift wrap and a credit applied for a coupon.*

*Image description: A screenshot of a webpage payment sheet that includes an additional charge for gift wrap and a credit applied for a coupon.*
...
*Image description: A screenshot of an Apple Pay payment sheet on iPhone, which shows a website icon above the payment details.*
...
*Image description: A screenshot of an in-app Apple Pay payment sheet on iPhone that shows an error with the shipping address. Payment sheet error messaging*

*Image description: A screenshot of a webpage Apple Pay payment sheet that shows an error with the shipping address. Payment sheet error messaging*

*Image description: A screenshot of a webpage Apple Pay payment sheet that shows an error with the shipping address. An overlay appears over the payment sheet and denotes the postal code doesn't match the country for the selected address. Options exist to select a different shipping address or edit the shipping address. Custom detail view error messaging*
...
*Image description: A screenshot of an in-app Apple Pay payment sheet for a fixed subscription, which includes a monthly amount. Fixed subscription*

*Image description: A screenshot of an in-app Apple Pay payment sheet for a variable subscription, which includes the text 'Amount Pending'. Variable subscription (where local regulations allow)*

*Image description: A screenshot of a webpage Apple Pay payment sheet for a fixed subscription, which includes a monthly amount. Fixed subscription*
...
*Image description: A screenshot of an in-app Apple Pay payment sheet for a fixed subscription that doesn’t require payment until after a three-month trial. The total shows a zero dollar amount. No payment required at authorization*

*Image description: A screenshot of a webpage Apple Pay payment sheet for a fixed subscription that doesn’t require payment until after a three-month trial. The total shows a zero dollar amount. No payment required at authorization*
...
*Image description: Apple Pay button displaying an image of someone's default payment card.*

| Payment button type | Example usage |
| --- | --- |
| *Image description: Buy with Apple Pay button* | An area in an app or website where people can make a purchase, such as a product detail page or shopping cart page. |
| *Image description: Pay with Apple Pay button* | An app or website that lets people pay bills or invoices, such as those for a utility — like cable or electricity — or a service like plumbing or car repair. |
| *Image description: Check Out with Apple Pay button* | An app or website offering a shopping cart or purchase experience that includes other payment buttons that start with the text *Check Out*. |
| *Image description: Continue with Apple Pay button* | An app or website offering a shopping cart or purchase experience that includes other payment buttons that start with the text *Continue*. |
| *Image description: Book with Apple Pay button* | An app or website that helps people book flights, trips, or other experiences. |
| *Image description: Donate with Apple Pay button* | An app or website for an [approved nonprofit](https://developer.apple.com/support/apple-pay-nonprofits/) that lets people make donations. |
| *Image description: Subscribe with Apple Pay button* | An app or website that lets people purchase a subscription, such as a gym membership or a meal-kit delivery service. |
| *Image description: Reload with Apple Pay button* | An app or website that uses the term *Reload* to help people add money to a card, account, or payment system associated with a service, such as transit or a prepaid phone plan. |
| *Image description: Add Money with Apple Pay button* | An app or website that uses the term *Add Money* to help people add money to a card, account, or payment system associated with a service, such as transit or a prepaid phone plan. |
| *Image description: Top Up with Apple Pay button* | An app or website that uses the term *Top Up* to help people add money to a card, account, or payment system associated with a service, such as transit or a prepaid phone plan. |
| *Image description: Order with Apple Pay button* | An app or website that lets people place orders for items like meals or flowers. |
| *Image description: Rent with Apple Pay button* | An app or website that lets people rent items like cars or scooters. |
| *Image description: Support with Apple Pay button* | An app or website that uses the term *Support* to help people give money to projects, causes, organizations, and other entities. |
| *Image description: Contribute with Apple Pay button* | An app or website that uses the term *Contribute* to help people give money to projects, causes, organizations, and other entities. |
| *Image description: Tip with Apple Pay button* | An app or website that lets people tip for goods or services. |
| *Image description: Apple Pay button* | An app or website that has stylistic reasons to use a button that can have a smaller minimum width or that doesn’t specify a call to action. If you choose a payment button type that isn’t supported on the version of the operating system your app or website is running in, the system may replace it with this button. |
...
*Image description: Set Up Apple Pay button*
...
*Image description: An illustration showing the correct placement of a black Apple Pay button over a light background.*

*Image description: Correct usage*

*Image description: An illustration showing the incorrect placement of a black Apple Pay button over a dark background.*
...
*Image description: An illustration showing the correct placement of a white, outlined Apple Pay button over a light background.*

*Image description: Correct usage*

*Image description: An illustration showing the incorrect placement of a white, outlined Apple Pay button over a dark background.*
...
*Image description: An illustration showing the correct placement of a white Apple Pay button over a dark background.*

*Image description: Correct usage*

*Image description: An illustration showing the incorrect placement of a white Apple Pay button over a light background.*
...
*Image description: An illustration showing an Apple Pay button positioned correctly above a custom Add to Cart button. Both buttons are the same size.*

*Image description: Correct usage*

*Image description: An illustration showing an Apple Pay button positioned incorrectly at a smaller size above a larger custom Add to Cart button.*
...
*Image description: An illustration showing a Check Out with Apple Pay button correctly positioned to the right of a custom Add to Cart button.*

*Image description: Correct usage*

*Image description: An illustration showing a Check Out with Apple Pay button incorrectly positioned to the left of a custom Add to Cart button.*

*Image description: Incorrect usage*

In a stacked layout, place the Apple Pay button above an Add to Cart button.

*Image description: An illustration of a Check Out with Apple Pay button correctly positioned above a custom Add to Cart button.*

*Image description: Correct usage*

*Image description: An illustration of a Check Out with Apple Pay button incorrectly positioned below a custom Add to Cart button.*
...
*Image description: An illustration showing a Check Out with Apple Pay button above a custom Add to Cart button. Both buttons have 90-degree corners. Minimum corner radius*

*Image description: An illustration showing a Check Out with Apple Pay button above a custom Add to Cart button. Both buttons have the default corner radius. Default corner radius*

*Image description: An illustration showing a Check Out with Apple Pay button above a custom Add to Cart button. Both buttons have the maximum corner radius, which results in a capsule-shaped appearance. Maximum corner radius*
...
*Image description: An illustration of an Apple Pay button, labeled to indicate minimum margins of one-tenth the button’s height, a 100-point minimum width, and a 30-point minimum height.*

*Image description: An illustration of a Donate with Apple Pay button, labeled to indicate minimum margins of one-tenth the button’s height, a 140-point minimum width, and a 30-point minimum height.*
...
*Image description: A row of four credit card logos, all of which are the same size and shape. The leftmost logo is the Apple Pay mark.*
...
|  | Example text |
| --- | --- |
| *Image description: Correct usage* | Purchase with Apple Pay |
| *Image description: Correct usage* | Purchase with Apple Pay® |
| *Image description: Incorrect usage* | Purchase with ApplePay |
| *Image description: Incorrect usage* | Purchase with  Pay |
| *Image description: Incorrect usage* | Purchase with APPLE PAY (when not conforming to an interface style that uses only capital letters) |
