...
*Image description: A sketch of the AirPlay icon. The image is overlaid with rectangular and circular grid lines and is tinted blue to subtly reflect the blue in the original six-color Apple logo.*
...
*Image description: A screenshot of the system-provided media player paused while playing a video.*
...
*Image description: Two black AirPlay icons. The left one is the audio AirPlay icon, represented by a triangle below three concentric lines. The right one is the video AirPlay icon, represented by a triangle below a rounded rectangle.*

### White AirPlay icon

Use the white AirPlay icon on black or dark backgrounds when other technology icons also appear in white.

*Image description: Two white AirPlay icons. The left one is the audio AirPlay icon, represented by a triangle below three concentric lines. The right one is the video AirPlay icon, represented by a triangle below a rounded rectangle.*

### Custom color AirPlay icon

Use a custom color when other technology icons also appear in the same color.

*Image description: Two blue AirPlay icons. The left one is the audio AirPlay icon, represented by a triangle below three concentric lines. The right one is the video AirPlay icon, represented by a triangle below a rounded rectangle.*
...
| *Image description: An X in a circle to indicate incorrect usage.* | You can AirPlay with [App Name] |
...
| *Image description: A checkmark in a circle to indicate correct usage.* | You can use AirPlay with [App Name] |
| *Image description: An X in a circle to indicate incorrect usage.* | [App Name] has AirPlay |
