...
*Image description: An illustration of an app window on iPad, with its menu bar appearing at the top of the screen and the Edit menu open.*
...
*Image description: A screenshot of the Input menu bar extra and its menu.*
