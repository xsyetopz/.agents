...
*Image description: A sketch of a photo, suggesting imagery. The image is overlaid with rectangular and circular grid lines and is tinted yellow to subtly reflect the yellow in the original six-color Apple logo.*
...
*Image description: Image of a circle that's in standard resolution at scale factor of @1x, and is 10 by 10 pixels. 1x (10x10 px)*

*Image description: Image of a circle that's in high resolution at a scale factor of @2x, and is 20 by 20 pixels. 2x (20x20 px)*
...
*Video description: An animation of a tvOS app icon moving to show the parallax effect.*
