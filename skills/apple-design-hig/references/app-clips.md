...
*Image description: A screenshot of an iPhone Lock Screen. The bottom half of the screen shows the App Clip card for a donut shop’s App Clip as it appears when the person invokes the App Clip.*

*Image description: A screenshot of a donut shop’s App Clip on iPhone as it appears when a person confirms the App Clip’s launch on the App Clip card. The App Clip displays a list with various donuts the person can order.*
...
*Image description: A horizontal row of two App Clip cards. The left App Clip card is for a game and uses Play as the verb for the action button. The right App Clip card is for an app and uses Open as the verb for the action button.*
...
*Image description: An App Clip Code that uses a badge design with the App Clip logo. App Clip Code with the App Clip logo*

*Image description: An App Clip Code that uses a design without the App Clip logo. App Clip Code without the App Clip logo*
...
*Image description: A scan-only App Clip Code with callouts for the center icon, visual code, and the App Clip logo.*
...
*Image description: A correctly placed App Clip Code in the upright position.*

*Image description: A checkmark in a circle to indicate correct usage.*

*Image description: An incorrectly placed App Clip Code that's rotated 90 degrees to the left.*

*Image description: An X in a circle to indicate an invalid App Clip Code.*

*Image description: An incorrectly placed App Clip Code that's rotated 135 degrees to the right.*
...
*Image description: An App Clip Code that uses the badge design and has a minimum diameter of 3/4 inch (1.9 cm).*

*Image description: An App Clip Code that uses the design without the App Clip logo and has a minimum diameter of 3/4 inch (1.9 cm).*
...
*Image description: An illustration of an App Clip Code next to a QR code. Red guides denote that both are the same size.*
...
*Image description: An illustration that shows an App Clip Code with the badge design to the left of an App Clip Code without the App Clip logo. A red guide surrounds each App Clip Code, illustrating the clear space requirements.*
...
*Image description: An illustration of an invalid App Clip Code with a color gradient instead of a solid background color.*

*Image description: An X in a circle to indicate an invalid App Clip Code.*

*Image description: An illustration of an invalid App Clip Code with a drop shadow effect.*
...
*Image description: An illustration of an App Clip Code that uses the badge design and has callouts for the background, foreground, and generated colors.*
