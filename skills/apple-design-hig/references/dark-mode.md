...
*Image description: A sketch of concentric circles with half-filled areas, suggesting the presence of light and dark. The image is overlaid with rectangular and circular grid lines and is tinted yellow to subtly reflect the yellow in the original six-color Apple logo.*
...
*Image description: A screenshot of the Stocks app on iPhone in its standard dark-only appearance, showing the Apple Inc. stock in detail. The view includes a summary of the current stock price along with a graph of its performance over the past year. The Stocks app uses a dark-only appearance*
...
*Image description: An illustration of a square with a light background and four color swatches representing system colors in the light appearance. System colors in the light appearance*

*Image description: An illustration of a square with a dark background and four color swatches representing system colors in the dark appearance. System colors in the dark appearance*
...
*Image description: An illustration of a black droplet icon against a light background. Icon in the light appearance with no border*

*Image description: An illustration of a black droplet icon against a dark background. The icon has a white border to distinguish it from the similar surrounding color. Icon in the dark appearance with border for better contrast*
...
*Image description: An illustration of two people sitting at a restaurant table done in a simple, abstract style. The illustration has a light background and its details are clearly visible. Illustration on a light background*

*Image description: An illustration of two people sitting at a restaurant table done in a simple, abstract style. The illustration has a dark background, and the darker portions of the image are hard to distinguish from the background. On a dark background, the same illustration has poor contrast and many details are lost*

*Image description: An illustration of two people sitting at a restaurant table done in a simple, abstract style. The illustration has a dark background, and its color values are adjusted to be clearly visible in contrast to the background. Illustration adjusted for better contrast on a dark background*
...
*Image description: An illustration of a button in the light appearance with dark primary label text. Primary label in the light appearance*

*Image description: An illustration of a button in the dark appearance with light secondary label text. Secondary label in the dark appearance*
...
*Image description: A diagram that shows a stack of 4 terms on top of a nearly black background. The term at the top shows the most contrast with the background and the term at the bottom shows the least. Elevated*

*Image description: A diagram that shows a stack of 4 terms on top of a white background. The term at the top shows the most contrast with the background and the term at the bottom shows the least. Light*
