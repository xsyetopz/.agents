...
*Image description: A sketch of progressively larger curved lines extending toward the right within a circle, suggesting Tap to Pay on iPhone. The image is overlaid with rectangular and circular grid lines and is tinted blue to subtly reflect the blue in the original six-color Apple logo.*
...
*Image description: An illustration of an app screen that describes the feature and contains a button labeled 'Enable Tap to Pay on iPhone'. An app screen that offers a way to accept Tap to Pay on iPhone terms and conditions*

*Image description: An illustration of an app screen that contains a button labeled 'Try a test transaction'. An app screen that shows Tap to Pay on iPhone is enabled and offers a way to try it*
...
*Image description: An illustration of an app's Tutorials screen in Settings, with a link to open the merchant education tutorial experience. Your app’s settings area is a good place to make sure the tutorial is always available.*

*Image description: An illustration of the Tap to Pay on iPhone merchant education tutorial sheet, which includes an image of the Tap to Pay behavior and instructions for how to accept a first payment. The merchant education tutorial provided by the `ProximityReaderDiscovery` API.*
...
*Image description: An illustration of an app screen that displays a determinate progress indicator followed by the text 'Preparing Tap to Pay on iPhone' above a purchase total. An app screen that displays a determinate progress indicator during configuration*

*Image description: An illustration of an app screen that displays an indeterminate progress indicator followed by the text 'Preparing Tap to Pay on iPhone' above a purchase total. An app screen that displays an indeterminate progress indicator during configuration*
...
*Image description: An illustration of a 'Tap to Pay' button containing an icon. The button incorrectly includes the Apple logo followed by the words 'Tap to Pay on iPhone'.*
...
*Image description: An illustration of an app's checkout screen showing an indeterminate progress indicator followed by the text 'Authorizing' above a purchase total.*
...
*Image description: An illustration of an app's checkout screen showing a green checkmark in a green circle above a purchase total. Below the total is the text 'Select receipt option' followed by a stack of three buttons.*

*Image description: An illustration of an app's checkout screen showing a red X in a red circle above a purchase total. Below the total is the text 'Select receipt option' followed by a stack of three buttons.*
...
*Image description: An illustration of an app's checkout screen showing a red X in a red circle above the text 'Payment not completed' followed by a purchase total. Below the total is the text 'Select payment option' followed by four buttons, including Tap to Pay on iPhone.*
...
*Image description: An illustration of a button labeled 'Tap to Pay on iPhone - Loyalty'.*
...
- [PaymentCardReader.Event.updateProgress(_:)](https://developer.apple.com/documentation/ProximityReader/PaymentCardReader/Event/updateProgress(_:))
- [prepare(using:)](https://developer.apple.com/documentation/ProximityReader/PaymentCardReader/prepare(using:))
