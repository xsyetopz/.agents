...
*Image description: A sketch of two outward-pointing arrows arranged in a vertical line extending from the upper-left to the bottom-right, suggesting expansion. The image is overlaid with rectangular and circular grid lines and is tinted orange to subtly reflect the orange in the original six-color Apple logo.*
...
- [toggleFullScreen(_:)](https://developer.apple.com/documentation/AppKit/NSWindow/toggleFullScreen(_:))
