...
*Image description: An illustration that shows the compact leading and compact trailing views in the Dynamic Island.*
...
*Image description: An illustration that shows the minimal presentation in the Dynamic Island.*
...
*Image description: An illustration that shows the expanded view in the Dynamic Island.*
...
*Image description: A screenshot of a Live Activity on the Lock Screen of iPhone that supports the Dynamic Island.*
...
*Image description: A screenshot of a Live Activity that appears as a banner on the Home Screen of iPhone without Dynamic Island support.*
...
*Image description: An image that shows the Lock Screen presentation of a Live Activity in StandBy, scaled up by 2x, with a dotted border to indicate the 2x scaling of the Live Activity.*
...
*Image description: An illustration that shows text in the Dynamic Island with heavier weights and legible size.*
...
*Image description: An illustration that shows content in the Dynamic Island with even margins.*
...
*Image description: An illustration a Live Activity that draws content to the edge of the Dynamic Island.*

Keep content compact and snug within a margin that’s concentric to the outer edge of the Live Activity.

*Image description: An illustration that shows how a Live Activity places an icon too far from the edge of the Dynamic Island.*

*Image description: An X in a circle to indicate incorrect usage.*

*Image description: An illustration that shows how a Live Activity places an icon close to the edge of the Dynamic Island without poking into the rounded shape of the Dynamic Island.*
...
*Image description: An illustration that shows how a Live Activity draws content all the way to the edge of the Dynamic Island to separate content.*

*Image description: An X in a circle to indicate incorrect usage.*

*Image description: An illustration of a Live Activity with content in an inset, rounded shape to group it together.*

*Image description: A checkmark in a circle to indicate correct usage.*

*Image description: An illustration of a Live Activity that uses a line to separate a block of content.*
...
*Image description: An illustration that shows a Live Activity with blurred text that's too far from the edge of the Dynamic Island.*

*Image description: An X in a circle to indicate incorrect usage.*

*Image description: An illustration that shows a Live Activity with blurred text that's close to the edge of the Dynamic Island without poking into the rounded shape of the Dynamic Island.*
...
*Image description: An illustration that shows a compact presentation that appears unbalanced and too wide because it uses padding around the TrueDepth camera.*

*Image description: An X in a circle to indicate incorrect usage.*

*Image description: An illustration that shows a compact presentation that’s snug around the TrueDepth camera.*
...
*Image description: An illustration that shows an expanded presentation of a Live Activity that leaves empty space next to the TrueDepth camera.*

*Image description: An X in a circle to indicate incorrect usage.*

*Image description: An illustration that shows an expanded presentation of a Live Activity that uses the space next to the TrueDepth camera.*
...
*Image description: A Live Activity, scaled to fill the screen on iPhone in StandBy.*
...
*Image description: An illustration that shows the compact presentation of a Live Activity in the Dynamic Island on iPhone. iPhone compact view*

*Image description: An illustration that shows the automatically generated default presentation of a Live Activity in a Smart Stack view, with the leading and trailing elements from the iPhone compact view spaced apart in the lower corners. Default Smart Stack view*

*Image description: An illustration that shows a custom presentation of a Live Activity in a Smart Stack view, with a balanced design that shows a graphical countdown timer balanced with explanatory text. Custom Smart Stack view*
