...
*Image description: A sketch of a play button, suggesting video playback. The image is overlaid with rectangular and circular grid lines and is tinted orange to subtly reflect the orange in the original six-color Apple logo.*
...
*Image description: An illustration of iPhone in landscape orientation. A blue rectangle shows the AVKit safe area within the screen. Overlaying the safe area and extending beyond it on all sides is a purple rectangle that represents the 4:3 video area, which doesn't include any embedded padding.*

*Image description: A checkmark in a circle to indicate correct usage. 4:3 video in full-screen viewing mode*

*Image description: An illustration of iPhone in landscape orientation. A blue rectangle shows the AVKit safe area within the screen. Overlaying the safe area and extending beyond its top and bottom edges is a purple rectangle that represents the 4:3 video area. Attached to the left and right edges of the purple rectangle are two vertical pink rectangles that extend to the left and right device edges, representing embedded pillarboxes.*

*Image description: An X in a circle to indicate incorrect usage. 4:3 video with embedded padding, in full-screen viewing mode*

*Image description: A legend for the illustrations, identifying blue as the AVKit safe area, purple as the video area, and pink as the embedded padding.*

*Image description: An illustration of iPhone in landscape orientation. A blue rectangle shows the AVKit safe area within the screen. Overlaying the safe area and extending to the top and bottom edges of the device is a purple rectangle representing the 21:9 video area, which doesn't include any embedded padding.*

*Image description: A checkmark in a circle to indicate correct usage. 21:9 video in fit-to-screen viewing mode*
...
*Image description: An X in a circle to indicate incorrect usage. 21:9 video with embedded padding, in fit-to-screen viewing mode*
