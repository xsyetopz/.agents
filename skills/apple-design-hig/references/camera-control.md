...
*Image description: A stylized representation of the Camera Control.*
...
*Image description: A screenshot showing callouts to the Camera Control and overlay on iPhone in landscape orientation.*
...
*Image description: A partial screenshot of the Camera Control overlay displaying its controls. Controls in the overlay*
...
*Image description: A partial screenshot of the Camera Control overlay displaying a slider control. Slider control*

*Image description: A partial screenshot of the Camera Control overlay displaying a picker control. Picker control*
...
*Image description: A partial screenshot of the Camera Control overlay displaying the system zoom factor control. Zoom factor control*

*Image description: A partial screenshot of the Camera Control overlay displaying the system exposure bias control. Exposure bias control*
...
*Image description: A partial screenshot of the Camera Control overlay displaying a camera flash control that uses the bolt.fill symbol. The `bolt.fill` symbol that represents a control for the camera flash*

*Image description: A partial screenshot of the Camera Control overlay displaying a camera filters control that uses the camera.filters symbol. The `camera.filters` symbol that represents a control for filters*
...
*Image description: A partial screenshot showing an example of the Camera Control overlay with a slider control displaying a value and context for the type of value.*

*Image description: A checkmark in a circle to indicate correct usage. Value with context*

*Image description: A partial screenshot showing an example of the Camera Control overlay with a slider control displaying a value without information about what the value represents.*

*Image description: An X in a circle to indicate incorrect usage. Value without context*
...
*Image description: Partial screenshots showing the Camera Control overlay with its control's label in the viewport in portrait and landscape orientations on iPhone.*
...
*Image description: A partial screenshot showing an example of the Camera Control overlay with UI elements removed from the capture viewport.*

*Image description: A checkmark in a circle to indicate correct usage. Keep UI minimal.*

*Image description: A partial screenshot showing an example of the Camera Control overlay with UI elements duplicated in the capture viewport.*

*Image description: An X in a circle to indicate incorrect usage. Avoid showing controls in the viewfinder that people access in the overlay.*
