...
*Image description: A sketch that suggests Apple Vision Pro. The image is overlaid with rectangular and circular grid lines and is tinted yellow to subtly reflect the yellow in the original six-color Apple logo.*
...
*Image description: A screenshot of a window in the Shared Space.*

*Image description: A screenshot of a highlighted window in the Shared Space with dimmed passthrough.*
...
*Video description: A recording of a fully immersive experience in which a video player window appears on top of an Environment. As the viewer adjusts the Digital Crown, passthrough increases to reveal more of the person's physical surroundings.*
...
*Image description: A screenshot of an app running in a Full Space using the mixed immersion style in visionOS. Mixed immersion style in a Full Space blending in-app objects with real-world surroundings*

*Image description: A screenshot of an app running in a Full Space using the progressive immersion style in visionOS. Progressive immersion style in a Full Space blending the app’s custom environment with real-world surroundings*

*Image description: A screenshot of an app running in a Full Space using the full immersion style in visionOS. Full immersion style in a Full Space showing a 360-degree custom environment*
