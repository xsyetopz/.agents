...
*Image description: A stylized representation of a menu containing a selected item and displaying a submenu. The image is tinted red to subtly reflect the red in the original six-color Apple logo.*
...
*Image description: An illustration of a menu containing the days of the week. Each menu item is represented by a different symbol with no relation to the corresponding day.*

*Image description: An X in a circle to indicate incorrect usage.*

*Image description: An illustration of a menu containing the days of the week with no accompanying symbols.*
...
*Image description: An illustration of a menu containing two groups. The top group contains four items, and none of them have a corresponding icon. The bottom group contains two items, and each of them have an icon.*
...
*Image description: An illustration of a menu containing four items, with a checkmark icon on the leading edge of the second item.*
...
*Image description: A diagram showing small, medium, and large menu layouts, each containing the same set of menu items.*
...
- [breakthrough effect](https://developer.apple.com/documentation/swiftui/view/presentationbreakthrougheffect(_:))
