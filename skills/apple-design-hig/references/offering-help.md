...
*Image description: A sketch of a question mark, suggesting help is available. The image is overlaid with rectangular and circular grid lines and is tinted orange to subtly reflect the orange in the original six-color Apple logo.*
...
*Image description: An illustration of a popover-style tip on iPhone. The tip appears atop nearby content, and points to a feature depicted by a blue star icon. The content beneath the tip is obscured. Popover*

*Image description: An illustration of an annotation-style tip on iPhone. The tip is embedded among the surrounding content, and points to a feature depicted by a blue star icon. Displaced text appears above and below the tip. Annotation*

*Image description: An illustration of an hint-style tip on iPhone. The tip is embedded among the surrounding content. Displaced text appears above and below the tip. Hint*
...
*Image description: An illustration of a hint-style tip with an unfilled blue star symbol on the leading side.*

*Image description: An X in a circle to indicate incorrect usage.*

*Image description: An illustration of a hint-style tip with a filled blue star symbol on the leading side.*
...
*Image description: An illustration of an annotation-style tip pointing to a feature depicted by a blue star icon. The tip includes a similar blue star symbol on its leading side.*

*Image description: An X in a circle to indicate incorrect usage.*

*Image description: An illustration of an annotation-style tip pointing to a feature depicted by a blue star icon. The tip is text-only and omits an accompanying symbol.*
...
- [help(_:)](https://developer.apple.com/documentation/SwiftUI/View/help(_:)-6oiyb)
