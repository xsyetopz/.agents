...
*Image description: A sketch of a curved arrow beside a Digital Crown, that suggests turning the Digital Crown. The image is overlaid with rectangular and circular grid lines and is tinted purple to subtly reflect the purple in the original six-color Apple logo.*
...
*Image description: A close-up photograph of a person's head wearing Apple Vision Pro, with their index finger pointing at the Digital Crown. The Digital Crown on Apple Vision Pro*

*Image description: A close-up photograph of Apple Watch, shown at an angle, with the Digital Crown prominently featured at the center of the image. The Digital Crown on Apple Watch*
