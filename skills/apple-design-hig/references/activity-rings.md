...
*Image description: A stylized representation of a set of move, exercise, and stand activity rings denoting progress. The image is tinted red to subtly reflect the red in the original six-color Apple logo.*
...
*Image description: A screenshot of an in-progress workout screen that displays the current timer value, followed by a list of the current Move, Exercise, and Stand values. The screen also displays an image of the Activity rings, where the state of each ring represents the current value.*
...
| Move | Exercise | Stand |
| --- | --- | --- |
| *Image description: R-250,G-17,B-79* | *Image description: R-166,G-255,B-0* | *Image description: R-0,G-255,B-246* |
...
*Image description: A screenshot of the Activity summary in the iOS Fitness app with Apple Watch paired. All three Activity rings are displayed. Apple Watch paired*

*Image description: A screenshot of the Activity summary in the iOS Fitness app with no Apple Watch paired. Only the Move ring is displayed. No Apple Watch paired*
