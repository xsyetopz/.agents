...
*Image description: A sketch of the Apple logo, suggesting Sign in with Apple. The image is overlaid with rectangular and circular grid lines and is tinted blue to subtly reflect the blue in the original six-color Apple logo.*
...
*Image description: An illustration representing an order confirmation screen on iPhone. The screen includes buttons titled 'Create Account' and 'Sign up with Apple'.*
...
*Image description: An illustration of a button that includes the Apple logo and text that reads 'Sign in with Apple'.*

*Image description: An illustration of a button that includes the Apple logo and text that reads 'Sign up with Apple'.*

*Image description: An illustration of a button that includes the Apple logo and text that reads 'Continue with Apple'.*

For watchOS, the system provides one title:  Sign in.

*Image description: An illustration of a button for watchOS, that includes the Apple logo and text that reads 'Sign in'.*
...
*Image description: An illustration of a white button correctly positioned on a dark shaded background. The button includes the Apple logo and text that reads 'Sign in with Apple'.*

*Image description: A checkmark in a circle to indicate correct usage.*

*Image description: An illustration of a white button incorrectly positioned on a light shaded background. The button includes the Apple logo and text that reads 'Sign in with Apple'.*
...
*Image description: An illustration of a white, outlined button correctly positioned on a light shaded background. The button includes the Apple logo and text that reads 'Sign in with Apple'.*

*Image description: A checkmark in a circle to indicate correct usage.*

*Image description: An illustration of a white, outlined button incorrectly positioned on a dark shaded background. The button includes the Apple logo and text that reads 'Sign in with Apple'.*
...
*Image description: An illustration of a black button correctly positioned on a light shaded background. The button includes the Apple logo and text that reads 'Sign in with Apple'.*

*Image description: A checkmark in a circle to indicate correct usage.*

*Image description: An illustration of a black button incorrectly positioned on a dark shaded background. The button includes the Apple logo and text that reads 'Sign in with Apple'.*
...
*Image description: An illustration of a dark shaded button for watchOS on a black background, that includes the Apple logo and text that reads 'Sign in'.*
...
*Image description: An illustration of a 'Sign in with Apple' button with 90-degree corners. Minimum corner radius*

*Image description: An illustration of a 'Sign in with Apple' button with the default corner radius. Default corner radius*

*Image description: An illustration of a 'Sign in with Apple' button with the maximum corner radius, which results in a capsule-like appearance. Maximum corner radius*
...
*Image description: A illustration of a black Apple logo within a white square, which is surrounded by a thick, shaded border. The white square represents the minimum amount of clear space between the Apple logo and other interface elements.*

*Image description: A illustration of a white Apple logo within a black square, which is surrounded by a thick, light border. The black square represents the minimum amount of clear space between the Apple logo and other interface elements.*
...
*Image description: An illustration of a Sign in with Apple button, with callouts that indicate a button height of 44 points and a font size of 19 points.*

*Image description: An illustration of a Sign in with Apple button, with callouts that indicate a button height of 56 points and a font size of 24 points.*
...
*Image description: An illustration of a logo-only Sign in with Apple button. The button includes only the Apple logo, and the button has rounded corners. Rounded rectangle mask*

*Image description: An illustration of a logo-only Sign in with Apple button. The button includes only the Apple logo, and the button has square corners. No mask*

*Image description: An illustration of a logo-only Sign in with Apple button. The button includes only the Apple logo, and the button is circular. Circular mask*
