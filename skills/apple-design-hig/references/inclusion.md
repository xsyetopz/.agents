...
*Image description: A sketch of two people, suggesting inclusion. The image is overlaid with rectangular and circular grid lines and is tinted yellow to subtly reflect the yellow in the original six-color Apple logo.*
...
*Image description: A solid silhouette of a person from the shoulders up, within a circle. person.crop.circle*

*Image description: Solid silhouettes of three people, with the left silhouette in the foreground and the other two in the background, all from the shoulders up. person.3.fill*

*Image description: A solid silhouette of a person standing with an arm raised high on the left side of the image. figure.wave*
