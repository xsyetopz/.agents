...
*Image description: A sketch of the App Store icon. The image is overlaid with rectangular and circular grid lines and is tinted yellow to subtly reflect the yellow in the original six-color Apple logo.*
...
*Image description: An image that shows three variations of the Photos app's app icon as it appears on different platforms. The first variation is a rounded rectangle shape, and represents the iOS, iPadOS, and macOS icons. The second variation is an elongated, rounded rectangular shape, and represents the tvOS icon. The third variation is a circular shape, and represents the visionOS and watchOS icons. All variations have the same overall design over different background shapes.*
...
*Video description: An animation of the Photos app icon in visionOS moving to show the parallax effect. visionOS app icon*
...
*Image description: A screenshot of the Photos app icon in Icon Composer. Icon Composer*
...
*Image description: An image of the Settings icon for iOS. The iOS, iPadOS, and macOS icon grid is overlaid on the icon to show how the icon's shape and its elements map to the grid.*

*Image description: An image of the Settings icon for tvOS. The tvOS icon grid is overlaid on the icon to show how the icon's shape and its elements map to the grid.*

*Image description: An image of the Settings icon for watchOS. The visionOS and watchOS icon grid is overlaid on the icon to show how the icon's shape and its elements map to the grid.*
...
*Image description: An image of the Podcasts app icon. The Podcasts app icon*

*Image description: An image of the Home app icon. The Home app icon*
...
*Image description: An illustration of two circles centered above a grid. One circle encloses the other. The inner circle has a solid fill. The outer circle is larger than the inner circle, allowing some space between them. The outer circle has no fill and shows just an outline.*

*Image description: An X in a circle to indicate incorrect usage.*

*Image description: An illustration of two circles centered above a grid. One circle encloses the other. The inner circle has a solid fill. The outer circle is larger than the inner circle, has no outline, and has a semi-transparent fill that allows the background grid to show through. Together, the two circles give the impression that the inner circle is resting upon the outer circle.*
...
*Image description: A grid showing the six different appearances of the Photos app icon in iOS. The top row shows the default, clear light, and tinted light icon variants. The bottom row shows the dark, clear dark, and tinted dark variants.*
...
*Image description: A diagram of the Settings icon in tvOS with a white dotted line inside the outer border, which indicates the safe zone.*
