...
- [Example A - Extensible compiler toolchain](#example-a---extensible-compiler-toolchain)
- [Example B - Stateful package-manager TUI](#example-b---stateful-package-manager-tui)
- [Example C - Binary protocol inspector and editor](#example-c---binary-protocol-inspector-and-editor)
- [Example D - Tool-using AI agent harness](#example-d---tool-using-ai-agent-harness)
- [Example E - Enterprise order processing](#example-e---enterprise-order-processing)
- [Sources](#sources)
...
Mermaid compatibility note (see `design-09-bibliography.md#github-mermaid-compatibility`)
...
- Context reduction: reload the goal, decisions, evidence pointers, outstanding tasks, and invariants.
