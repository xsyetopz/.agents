...
- [1. Master architecture workflow](#1-master-architecture-workflow)
- [2. Gate state machine](#2-gate-state-machine)
- [3. Classic MVC-style interaction](#3-classic-mvc-style-interaction)
- [4. MVU / reducer loop](#4-mvu-reducer-loop)
- [5. DDD bounded-context interaction](#5-ddd-bounded-context-interaction)
- [6. Batch compiler](#6-batch-compiler)
- [7. Incremental compiler / language server](#7-incremental-compiler-language-server)
- [8. Interpreter / abstract machine](#8-interpreter-abstract-machine)
- [9. Runtime with JIT feedback](#9-runtime-with-jit-feedback)
- [10. Non-interactive CLI](#10-non-interactive-cli)
- [11. TUI](#11-tui)
- [12. Agent harness](#12-agent-harness)
- [13. Long-running agent recovery](#13-long-running-agent-recovery)
- [14. Web API through ports and adapters](#14-web-api-through-ports-and-adapters)
- [15. Binary parser with staged trust](#15-binary-parser-with-staged-trust)
- [16. Event-driven service](#16-event-driven-service)
- [17. Durable workflow / saga](#17-durable-workflow-saga)
- [18. Vertical architecture slice](#18-vertical-architecture-slice)
- [19. Contradiction resolution](#19-contradiction-resolution)
- [Sources](#sources)

> Locally authored diagram guidance, not a primary source or generated snapshot; source gap: live verification of renderer behavior through the bibliography (see `design-09-bibliography.md`) is required before relying on syntax or architecture claims.
