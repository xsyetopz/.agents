...
- AGENTS.md format and scope: <https://agents.md/>
...
## Provenance and tool assistance
...
- Gemini context files and imports: <https://geminicli.com/docs/cli/gemini-md/>
...
- Actions permissions: <https://docs.github.com/en/actions/reference/workflows-and-actions/workflow-syntax#permissions>
