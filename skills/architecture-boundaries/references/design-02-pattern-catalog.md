...
- [2. Hexagonal architecture / ports and adapters](#2-hexagonal-architecture-ports-and-adapters)
- [3. Onion / clean architecture](#3-onion-clean-architecture)
- [4. Classic MVC](#4-classic-mvc)
- [5. MVP](#5-mvp)
- [6. MVVM](#6-mvvm)
- [7. MVU / reducer architecture](#7-mvu-reducer-architecture)
- [8. Presentation Model](#8-presentation-model)
- [9. PAC (Presentation–Abstraction–Control)](#9-pac-presentationabstractioncontrol)
- [10. Pipeline / pipe-and-filter](#10-pipeline-pipe-and-filter)
- [11. Pass manager](#11-pass-manager)
- [12. Interpreter](#12-interpreter)
- [13. Virtual machine / abstract machine](#13-virtual-machine-abstract-machine)
- [14. Visitor](#14-visitor)
- [15. Dataflow / DAG](#15-dataflow-dag)
- [16. State machine / statechart](#16-state-machine-statechart)
- [17. Event-driven architecture](#17-event-driven-architecture)
- [18. CQRS](#18-cqrs)
- [19. Event sourcing](#19-event-sourcing)
- [20. Actor model](#20-actor-model)
- [21. Supervisor–worker](#21-supervisorworker)
- [22. Scheduler–executor](#22-schedulerexecutor)
- [23. Blackboard](#23-blackboard)
- [24. Orchestrator–workers for AI agents](#24-orchestratorworkers-for-ai-agents)
- [25. Workflow / saga](#25-workflow-saga)
- [26. Reactor](#26-reactor)
- [27. Proactor](#27-proactor)
- [28. Microkernel / plugin architecture](#28-microkernel-plugin-architecture)
- [29. Repository](#29-repository)
- [30. Unit of Work](#30-unit-of-work)
- [31. Anti-corruption layer](#31-anti-corruption-layer)
- [32. Strangler migration](#32-strangler-migration)
- [33. Sidecar / adapter process](#33-sidecar-adapter-process)
- [34. Entity–Component–System](#34-entitycomponentsystem)
- [35. Broker / message bus](#35-broker-message-bus)
- [36. Shared-nothing partitioning](#36-shared-nothing-partitioning)
- [37. Cache-aside / materialized projection](#37-cache-aside-materialized-projection)
- [38. Parser–validator–IR](#38-parservalidatorir)
- [39. Command bus / application service](#39-command-bus-application-service)
- [40. Functional core, imperative shell](#40-functional-core-imperative-shell)
- [Pattern-combination rules](#pattern-combination-rules)
- [Sources](#sources)
