...
Remove confirmed obsolete compatibility surfaces and every live route to them without replacing one legacy path with another.
...
- The canonical replacement must be live before removal, and the change must not introduce another alias, wrapper, fallback, re-export, or shadow path.
