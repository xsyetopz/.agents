...
class SuppressionTests(AuditFixture, unittest.TestCase):
    ...
    def test_git_migration_replacement_allows_paired_test_file_change(self) -> None:
        self.init_git()
        ...
        self.assertFalse(any(item.code == "check-file-deleted" for item in git_suppression_findings(self.root)))

    def test_git_migration_placeholder_does_not_waive_test_deletion(self) -> None:
        self.init_git()
