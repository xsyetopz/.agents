...
| Observed failure categories | [anti-patterns.md](anti-patterns.md), then [issue-lookup.md](issue-lookup.md) |
| One issue case | [issues/index.md](issues/index.md), then the anchored case |
| Full case-ID inventory | [issue-corpus-index.md](issue-corpus-index.md) |

The official dated snapshots remain source records. Authored model and issue
guidance is a short route layer and must preserve source dates and explicit
evidence gaps.
