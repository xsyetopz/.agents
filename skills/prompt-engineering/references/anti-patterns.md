...
3. Open one category through references/issues/index.md, then select one
   anchored case from references/issue-corpus-index.md.
...
A larger corpus does not establish coverage; deduplicate cases that exercise
the same behavior.

## Routing

Use references/issue-lookup.md to choose a category, references/issues/index.md
