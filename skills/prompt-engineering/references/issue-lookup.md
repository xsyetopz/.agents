...
the category file through references/issues/index.md and the exact case anchor
through references/issue-corpus-index.md. Do not load all issue files or route
solely from complaint wording.
